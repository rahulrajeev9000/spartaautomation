...
public class RegisterNoDOBTest {
    ...
    @Test
    public void registerTestNoDOB() throws InterruptedException {
        ...
        Assert.assertEquals("http://automation-form.spartaglobal.education/",driver.getCurrentUrl());
